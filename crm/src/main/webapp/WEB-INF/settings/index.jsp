	...
	<div class="modal fade" id="exitModal" role="dialog">
		<div class="modal-dialog" role="document" style="width: 30%;">
			<div class="modal-content">
				...
				<div class="modal-footer">
					<button type="button" class="btn btn-default" data-dismiss="modal">取消</button>
					<button type="button" class="btn btn-primary" data-dismiss="modal" onclick="window.location.href='/crm/login.jsp';">确定</button>
				</div>
			</div>
		</div>
	</div>
			...
			<ul>
				<li class="dropdown user-dropdown">
					...
					<ul class="dropdown-menu">
						<li><a onclick="window.location.href='/crm/toView/workbench/main/index'" href="javascript:void(0)"><span class="glyphicon glyphicon-home"></span> 工作台</a></li>
						<li><a onclick="window.location.href='/crm/toView/settings/index'" href="javascript:void(0)"><span class="glyphicon glyphicon-wrench"></span> 系统设置</a></li>
